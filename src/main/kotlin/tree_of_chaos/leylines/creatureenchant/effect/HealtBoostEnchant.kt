...
class HealtBoostEnchant:EffectEnchantBase(MobEffects.HEALTH_BOOST,MobEffects.HEALTH_BOOST,-2.0, ResourceLocation(MOD_ID,"health_boost"),"health_boost") {

    companion object {
        @GameRegistry.ObjectHolder("$MOD_ID:protection")
        lateinit var protection: CreatureEnchant

        @GameRegistry.ObjectHolder("$MOD_ID:speed")
